...
public class SwimmerStatisticActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dop.insertStatistics(db, "wajiha", "123 freestyle", "00:00:00","3/12/2015", "01");
        dop.insertStatistics(db, "alina", "123 butterfly", "00:00:01","3/25/2015", "04");
        dop.insertStatistics(db, "wajiha", "321 freestyle", "00:00:17","4/9/2015", "02");
        dop.insertStatistics(db, "dfg", "123 freestyle", "00:90:00","4/8/2015", "01");
        dop.insertStatistics(db, "wajiha", "freestyle", "00:00:30","3/2/2015", "01");
        s_sort = "";
        s_event ="";
    ...
    private void sortList ()
    {
        ...
        if (current_sort == "Time")
        {
            ...
            SQLiteDatabase db = dop.getWritableDatabase();
            //Cursor cursor = db.rawQuery("SELECT * FROM Statistics_TABLE WHERE Name ='" + current_swimmer + "'", null);
            Cursor cursor = db.rawQuery("SELECT * FROM Statistics_TABLE ORDER BY "+current_sort+" ", null);
